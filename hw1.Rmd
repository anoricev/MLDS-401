...
```
For the IBM vs. S&P 500, there is a positive and slightly linear relationship between the variables. As the monthly rate of return for IBM increases, the monthly rate of return for the S&P 500 increases as well. 
...
The slope tells us that for every addition unit of horsepower, the miles per gallon will decrease by roughly .16 miles per gallon.
...
The slope coefficient for the year variable suggests that while holding all other predictors constant, a increase of one year will result in an additional .777 miles per gallon on average across the data set.

### (f) (2 points) What does the slope coefficient for the displacement variable suggest?
The slope coefficient for the displacement variable suggests that while holding all other predictors constant, a increase of one unit of displacement will result in an additional .024 miles per gallon on average across the data set.
