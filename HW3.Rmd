...
```{r data}
# Minimal, master's-level data loading (no elaborate fallbacks)
data_dir  <- "E:/mlds/MLDS 401 Machine Learning/course_files_export/Homework/HW3"
auto_path <- if (file.exists(file.path(data_dir, "auto.txt"))) file.path(data_dir, "auto.txt") else "auto.txt"
part_path <- if (file.exists(file.path(data_dir, "part.csv"))) file.path(data_dir, "part.csv") else "part.csv"
