...
From the fit results, we see tx's p value is 2e-16. This is smaller than 0.05. Therefore we reject the null hypothesis, and therefore do find evidence that participation has a significant effect on future spending. 
```{r}
exp(.24438)-1
```
